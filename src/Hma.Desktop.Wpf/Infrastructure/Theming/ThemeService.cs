...
public sealed class ThemeService
{
    ...
    public void Apply(string theme, bool persist = true)
    {
        ...
        var uri = name == Dark
            ? new Uri("pack://application:,,,/Hma.Desktop.Wpf;component/Infrastructure/Theming/Colors.Dark.xaml", UriKind.Absolute)
            : new Uri("pack://application:,,,/Hma.Desktop.Wpf;component/Infrastructure/Theming/Colors.Light.xaml", UriKind.Absolute);
