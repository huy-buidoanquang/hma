...
public class VehicleRulesTests
{
    ...
    public void Requires_plate_and_partner()
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            VehicleRules.EnsureCanSave(new Vehicle { PlateNumber = " ", PartnerId = 0 }));
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            VehicleRules.EnsureCanSave(new Vehicle { PlateNumber = "51C-12345", PartnerId = 1, Tonnage = -1 }));
    ...
    {
        VehicleRules.EnsureCanSave(new Vehicle { PlateNumber = "51C-12345", PartnerId = 1, Tonnage = 8 });
    }
    ...
    public void Canonicalizes_compact_and_lowercase_plates()
    {
        ...
        VehicleRules.EnsureCanSave(vehicle);
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            VehicleRules.EnsureCanSave(new Vehicle { PlateNumber = "51C-1", PartnerId = 1 }));
